...
public class Simulator {
	...
	/**
	 * Erzeugt eine neue Simulator Klasse.
	 * Dabei wird ein JOGL Fenster mit einer Roten Kugel geöffnet, die mit einer bestimmten Geschwindigkeit relativ  bewegt werden kann.
	 */
	public Simulator(){
		...
		canvas.addGLEventListener(new GLEventListener() {
			...
			public void display(GLAutoDrawable drawable) {
		        ...
		        //Die Geschwindigkeit gibt an, wieviele Einheiten sich pro Sekunde bewegt werden soll
		        ...
		        if(remainingMove != null){
		        	float moveDistance = (timeDifference+remainingTimeDifference)*remainingMove.getSpeed()/1000;

		        	float remainingDistance = (float) Math.sqrt((remainingMove.getX()*remainingMove.getX())+(remainingMove.getY()*remainingMove.getY())+(remainingMove.getZ()*remainingMove.getZ()));
		        	...
		        	if(proportion < 1){
		        		...
		        		remainingTimeDifference = timeDifference - (timeDifference/proportion);
		        ...
		        textRenderer.draw("X: "+x, drawable.getWidth()-80, drawable.getHeight()-20);
		        textRenderer.draw("Y: "+y, drawable.getWidth()-80, drawable.getHeight()-45);
		        textRenderer.draw("Z: "+z, drawable.getWidth()-80, drawable.getHeight()-70);
		        textRenderer.draw("FPS: "+fps, drawable.getWidth()-80, drawable.getHeight()-95);
